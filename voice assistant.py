...
def wishMe():
    ...
    if hour>=0 and hour<12:
        speak("happy morning mam")
    elif hour>=12 and hour<16:
        speak("you should eat and sleep mam")
    elif hour>=16 and hour<19:
        speak("good evening mam")
    else:
        speak("...good evening....mam")
    speak("i am your personal voice assistant , how may i help you? mam ")
...
while True:
    ...
    if 'wikipedia' in query.lower():
        ...
        speak("yes mam my name is EDITH")
        ...
        speak("yes mam")
        speak("my self EDITH , i am an A.I. voice assistant created by SHIVI JINDAL. I can do a lot of tasks like sending emails or opening different websites like youtube , google , instagram etc., also i can play songs for you if you want,all you need is to command me mam")
